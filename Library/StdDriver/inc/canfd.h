...
/// @cond HIDDEN_SYMBOLS
/* CAN FD sram address offset*/
#define CANFD_SRAM_BASE_ADDR          0x200ul
...
typedef enum
{
    eCANFD_TRANSMIT_FAIL     = 0, /*!< CANFD transmit fail */
    eCANFD_TRANSMIT_SUCCESS  = 1, /*!< CANFD transmit fail */
    eCANFD_TRANSMIT_TIMEOUT  = 2  /*!< CANFD transmit timeout */
} E_CANFD_TRANSMIT_STATE;

/*! CAN FD transmission state.*/
typedef enum
{
    eCANFD_RECEIVE_EMPTY     = 0,  /*!< CANFD receive empty */
    eCANFD_RECEIVE_SUCCESS   = 1,  /*!< CANFD receive success */
    eCANFD_RECEIVE_SUCCESS_AND_BUFFER_FULL   = 2 /*!< CANFD receive success and buffer full */
...
typedef struct
{
    union
    {
        struct
        {
            ...
            uint32_t reserved1 : 5;  /*!< \hideinitializer */
...
typedef struct
{
    union
    {
        struct
        {
            ...
            uint32_t reserved1 : 1;  /*!< \hideinitializer */
