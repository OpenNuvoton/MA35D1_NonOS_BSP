/**************************************************************************//**
 * @file     whc.h
 * @brief    Wormhole Controller (WHC) driver header file
 *
...
/**
  * @brief      Check TX message channel status
  *
  * @param[in]  whc           The pointer of the specified WHC module.
  * @param[in]  u32Ch         WHC channel, valid channel numbers are 0~3
  * \hideinitializer
...
/**
  * @brief      Check RX message channel status
  *
  * @param[in]  whc           The pointer of the specified WHC module.
  * @param[in]  u32Ch         WHC channel, valid channel numbers are 0~3
  * \hideinitializer
...
/**
  ...
  *    \hideinitializer
  */
#define WHC_SET_WAKEUP_SRC(whc,u32WakeupSrc)    ((whc)->WKCTL |= (u32WakeupSrc))
...
/**
  ...
  *    \hideinitializer
  */
#define WHC_CLR_WAKEUP_SRC(whc,u32WakeupSrc)    ((whc)->WKCTL &= ~(u32WakeupSrc))
