...
/**
  * @brief  Set QSPI MRxPhase.
  * @param[in]  qspi is the base address of QSPI module.
  * @param[in]  u32MRxPhase is master receive phase selection. The value should be 0 ~ 0xB.
  * @return none
  * \hideinitializer
  */
#define QSPI_SET_MRXPHASE(qspi, u32MRxPhase) ( (qspi)->INTERNAL = ((qspi)->INTERNAL & ~QSPI_INTERNAL_MRXPHASE_Msk) | (((u32MRxPhase)&0x1F) << QSPI_INTERNAL_MRXPHASE_Pos))
