...
/*---------------------------------------------------------------------------------------------------------*/
/*  GPIO Power Type Constant Definitions                                                               */
/*---------------------------------------------------------------------------------------------------------*/
#define GPIO_SPW_1_8_V         0x0UL           /*!< GPIO power setting for 1.8v Mode \hideinitializer */
#define GPIO_SPW_3_3_V         0x1UL           /*!< GPIO power setting for 3.3v Mode \hideinitializer */
...
#define PM0             GPIO_PIN_DATA(12, 0 ) /*!< Specify PM.0 Pin Data Input/Output \hideinitializer */
#define PM1             GPIO_PIN_DATA(12, 1 ) /*!< Specify PM.1 Pin Data Input/Output \hideinitializer */
#define PM2             GPIO_PIN_DATA(12, 2 ) /*!< Specify PM.2 Pin Data Input/Output \hideinitializer */
#define PM3             GPIO_PIN_DATA(12, 3 ) /*!< Specify PM.3 Pin Data Input/Output \hideinitializer */
#define PM4             GPIO_PIN_DATA(12, 4 ) /*!< Specify PM.4 Pin Data Input/Output \hideinitializer */
#define PM5             GPIO_PIN_DATA(12, 5 ) /*!< Specify PM.5 Pin Data Input/Output \hideinitializer */
#define PM6             GPIO_PIN_DATA(12, 6 ) /*!< Specify PM.6 Pin Data Input/Output \hideinitializer */
#define PM7             GPIO_PIN_DATA(12, 7 ) /*!< Specify PM.7 Pin Data Input/Output \hideinitializer */
#define PM8             GPIO_PIN_DATA(12, 8 ) /*!< Specify PM.8 Pin Data Input/Output \hideinitializer */
#define PM9             GPIO_PIN_DATA(12, 9 ) /*!< Specify PM.9 Pin Data Input/Output \hideinitializer */
#define PM10            GPIO_PIN_DATA(12, 10) /*!< Specify PM.10 Pin Data Input/Output \hideinitializer */
#define PM11            GPIO_PIN_DATA(12, 11) /*!< Specify PM.11 Pin Data Input/Output \hideinitializer */
#define PM12            GPIO_PIN_DATA(12, 12) /*!< Specify PM.12 Pin Data Input/Output \hideinitializer */
#define PM13            GPIO_PIN_DATA(12, 13) /*!< Specify PM.13 Pin Data Input/Output \hideinitializer */
#define PM14            GPIO_PIN_DATA(12, 14) /*!< Specify PM.14 Pin Data Input/Output \hideinitializer */
#define PM15            GPIO_PIN_DATA(12, 15) /*!< Specify PM.15 Pin Data Input/Output \hideinitializer */
#define PN0             GPIO_PIN_DATA(13, 0 ) /*!< Specify PN.0 Pin Data Input/Output \hideinitializer */
#define PN1             GPIO_PIN_DATA(13, 1 ) /*!< Specify PN.1 Pin Data Input/Output \hideinitializer */
#define PN2             GPIO_PIN_DATA(13, 2 ) /*!< Specify PN.2 Pin Data Input/Output \hideinitializer */
#define PN3             GPIO_PIN_DATA(13, 3 ) /*!< Specify PN.3 Pin Data Input/Output \hideinitializer */
#define PN4             GPIO_PIN_DATA(13, 4 ) /*!< Specify PN.4 Pin Data Input/Output \hideinitializer */
#define PN5             GPIO_PIN_DATA(13, 5 ) /*!< Specify PN.5 Pin Data Input/Output \hideinitializer */
#define PN6             GPIO_PIN_DATA(13, 6 ) /*!< Specify PN.6 Pin Data Input/Output \hideinitializer */
#define PN7             GPIO_PIN_DATA(13, 7 ) /*!< Specify PN.7 Pin Data Input/Output \hideinitializer */
#define PN8             GPIO_PIN_DATA(13, 8 ) /*!< Specify PN.8 Pin Data Input/Output \hideinitializer */
#define PN9             GPIO_PIN_DATA(13, 9 ) /*!< Specify PN.9 Pin Data Input/Output \hideinitializer */
#define PN10            GPIO_PIN_DATA(13, 10) /*!< Specify PN.10 Pin Data Input/Output \hideinitializer */
#define PN11            GPIO_PIN_DATA(13, 11) /*!< Specify PN.11 Pin Data Input/Output \hideinitializer */
#define PN12            GPIO_PIN_DATA(13, 12) /*!< Specify PN.12 Pin Data Input/Output \hideinitializer */
#define PN13            GPIO_PIN_DATA(13, 13) /*!< Specify PN.13 Pin Data Input/Output \hideinitializer */
#define PN14            GPIO_PIN_DATA(13, 14) /*!< Specify PN.14 Pin Data Input/Output \hideinitializer */
#define PN15            GPIO_PIN_DATA(13, 15) /*!< Specify PN.15 Pin Data Input/Output \hideinitializer */
