...
#define TPWM_CNTR_CLKSRC_TIMER4_INT          (5UL)    /*!< Timer PWM Clock source selects to TIMER4  interrupt event \hideinitializer */
#define TPWM_CNTR_CLKSRC_TIMER5_INT          (6UL)    /*!< Timer PWM Clock source selects to TIMER5  interrupt event \hideinitializer */
#define TPWM_CNTR_CLKSRC_TIMER6_INT          (7UL)    /*!< Timer PWM Clock source selects to TIMER6  interrupt event \hideinitializer */
#define TPWM_CNTR_CLKSRC_TIMER7_INT          (8UL)    /*!< Timer PWM Clock source selects to TIMER7  interrupt event \hideinitializer */
#define TPWM_CNTR_CLKSRC_TIMER8_INT          (9UL)    /*!< Timer PWM Clock source selects to TIMER8  interrupt event \hideinitializer */
#define TPWM_CNTR_CLKSRC_TIMER9_INT          (10UL)   /*!< Timer PWM Clock source selects to TIMER9  interrupt event \hideinitializer */
#define TPWM_CNTR_CLKSRC_TIMER10_INT         (11UL)   /*!< Timer PWM Clock source selects to TIMER10 interrupt event \hideinitializer */
#define TPWM_CNTR_CLKSRC_TIMER11_INT         (12UL)   /*!< Timer PWM Clock source selects to TIMER11 interrupt event \hideinitializer */
/*---------------------------------------------------------------------------------------------------------*/
...
/**
  ...
  *
  * @param[in]  timer   The pointer of the specified Timer module. It could be TIMER0~11.
  *
