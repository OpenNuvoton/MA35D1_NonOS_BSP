...
{
    uint32_t u32Index0 = ptr_to_u32(&EBI->CTL0 + (u32Bank * 0x10UL));
    uint32_t u32Index1 = ptr_to_u32(&EBI->TCTL0 + (u32Bank * 0x10UL));
    volatile uint32_t *pu32EBICTL  = (volatile uint32_t *)((uint64_t)u32Index0);
    volatile uint32_t *pu32EBITCTL = (volatile uint32_t *)((uint64_t)u32Index1);
...
{
    uint32_t u32Index = ptr_to_u32(&EBI->CTL0 + (u32Bank * 0x10UL));
    volatile uint32_t *pu32EBICTL  = (volatile uint32_t *)((uint64_t)u32Index);
