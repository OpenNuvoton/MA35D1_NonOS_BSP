...
/**
  ...
  *                                 - \ref TPWM_CNTR_CLKSRC_TIMER6_INT
  *                                 - \ref TPWM_CNTR_CLKSRC_TIMER7_INT
  *                                 - \ref TPWM_CNTR_CLKSRC_TIMER8_INT
  *                                 - \ref TPWM_CNTR_CLKSRC_TIMER9_INT
  *                                 - \ref TPWM_CNTR_CLKSRC_TIMER10_INT
  *                                 - \ref TPWM_CNTR_CLKSRC_TIMER11_INT
  *
