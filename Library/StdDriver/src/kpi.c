...
/**
  ...
  *
  * @param[in]    kpi      The pointer of the specified KPI module.
  * @param[in]    u32Key1: \ref KPI_KEY00 ~ \ref KPI_KEY77
  * @param[in]    u32Key2: \ref KPI_KEY00 ~ \ref KPI_KEY77
  * @param[in]    u32Key3: \ref KPI_KEY00 ~ \ref KPI_KEY77
  * @param[in]    u32RstCnt: Reset Period Count. The value is from 0 ~ 255.
  *
  */
