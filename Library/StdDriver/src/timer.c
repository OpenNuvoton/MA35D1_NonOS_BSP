...
/**
  ...
  * @param[in] timer The base address of Timer module. Can be TIMER0 or TIMER2 or TIMER4
  *            or TIMER6 or TIMER8 or TIMER10
  ...
  *          or TIMER4 and TIMER5 will be configured for this function. The mode used
  *          to calculate input event frequency is mentioned as "Inter Timer Trigger Mode"
