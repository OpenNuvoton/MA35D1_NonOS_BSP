...
typedef struct
{
    ...
    * |Bits    |Field     |Descriptions                                             
    * | :----: | :----:   | :---- |                                                 
    * |[0]     |DS0       |Port A-N Low Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n low byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                   
    * |        |          |111 = Px.n is maximum deiver strength.                   
    * |[1]     |DS1       |Port A-N Low Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n low byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                   
    * |        |          |111 = Px.n is maximum deiver strength.                   
    * |[2]     |DS2       |Port A-N Low Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n low byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                   
    * |        |          |111 = Px.n is maximum deiver strength.                   
    * |[3]     |DS3       |Port A-N Low Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n low byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                   
    * |        |          |111 = Px.n is maximum deiver strength.                   
    * |[4]     |DS4       |Port A-N Low Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n low byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                   
    * |        |          |111 = Px.n is maximum deiver strength.                   
    * |[5]     |DS5       |Port A-N Low Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n low byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                   
    * |        |          |111 = Px.n is maximum deiver strength.                   
    * |[6]     |DS6       |Port A-N Low Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n low byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                   
    * |        |          |111 = Px.n is maximum deiver strength.                   
    * |[7]     |DS7       |Port A-N Low Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n low byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                   
    * |        |          |111 = Px.n is maximum deiver strength.                   
    * @var GPIO_T::DSH
    ...
    * |Bits    |Field     |Descriptions                                              
    * | :----: | :----:   | :---- |                                                  
    * |[8]     |DS8       |Port A-N High Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n high byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                    
    * |        |          |111 = Px.n is maximum deiver strength.                    
    * |[9]     |DS9       |Port A-N High Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n high byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                    
    * |        |          |111 = Px.n is maximum deiver strength.                    
    * |[10]    |DS10      |Port A-N High Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n high byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                    
    * |        |          |111 = Px.n is maximum deiver strength.                    
    * |[11]    |DS11      |Port A-N High Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n high byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                    
    * |        |          |111 = Px.n is maximum deiver strength.                    
    * |[12]    |DS12      |Port A-N High Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n high byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                    
    * |        |          |111 = Px.n is maximum deiver strength.                    
    * |[13]    |DS13      |Port A-N High Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n high byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                    
    * |        |          |111 = Px.n is maximum deiver strength.                    
    * |[14]    |DS14      |Port A-N High Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n high byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                    
    * |        |          |111 = Px.n is maximum deiver strength.                    
    * |[15]    |DS15      |Port A-N High Byte pin[n] Driver Strength Control Register
    * |        |          |Determine each driver strength of Px.n high byte pins.    
    * |        |          |000 = Px.n is minimum deiver strength.                    
    * |        |          |111 = Px.n is maximum deiver strength.                    
    */
    ...
    __IO uint32_t SPW;           /* Offset: 0x06C/0xAC/0xEC/0x12C/0x16C/0x1AC/0x26C/0x2AC/0x36C */
    ...
    __IO uint32_t DSL;           /* Offset: 0x38/0x78/0xB8/0xF8/0x138/0x178/0x1B8/0x1F8/0x238/0x278/0x2B8/0x2F8/0x338/0x378  Port A-N Low-byte Driver Strength Control Register */
    __IO uint32_t DSH;           /* Offset: 0x3c/0x7C/0xBC/0xFC/0x13C/0x17C/0x1BC/0x1FC/0x23C/0x27C/0x2BC/0x2FC/0x33C/0x37C  Port A-N High-byte Driver Strength Control Register */
} GPIO_T;
