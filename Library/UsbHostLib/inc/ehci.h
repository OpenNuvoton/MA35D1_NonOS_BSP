...
#define QTD_PTR(x)                nc_ptr((uint64_t)(x) & ~0x1F)
 ...
 */
#define QH_HLNK_ITD(x)            ((uint32_t)(((uint64_t)(x) & ~0x1F) | 0x0))
#define QH_HLNK_QH(x)             ((uint32_t)(((uint64_t)(x) & ~0x1F) | 0x2))
#define QH_HLNK_SITD(x)           ((uint32_t)(((uint64_t)(x) & ~0x1F) | 0x4))
#define QH_HLNK_FSTN(x)           ((uint32_t)(((uint64_t)(x) & ~0x1F) | 0x6))
#define QH_PTR(x)                 nc_ptr((uint64_t)(x) & ~0x1F)
 ...
 */
#define ITD_HLNK_ITD(x)           ((uint32_t)(((uint64_t)(x) & ~0x1F) | 0x0))
#define ITD_HLNK_QH(x)            ((uint32_t)(((uint64_t)(x) & ~0x1F) | 0x2))
#define ITD_HLNK_SITD(x)          ((uint32_t)(((uint64_t)(x) & ~0x1F) | 0x4))
#define ITD_HLNK_FSTN(x)          ((uint32_t)(((uint64_t)(x) & ~0x1F) | 0x6))
#define ITD_PTR(x)                nc_ptr((uint64_t)(x) & ~0x1F)
 ...
 *  Next_Link[2:1] Typ field of "Next Schedule Element Pointer"  Typ field
 */
#define SITD_HLNK_ITD(x)          ((ptr_to_u32(x) & ~0x1F) | 0x0)
#define SITD_HLNK_QH(x)           ((ptr_to_u32(x) & ~0x1F) | 0x2)
#define SITD_HLNK_SITD(x)         ((ptr_to_u32(x) & ~0x1F) | 0x4)
#define SITD_HLNK_FSTN(x)         ((ptr_to_u32(x) & ~0x1F) | 0x6)
#define SITD_PTR(x)               nc_ptr((uint64_t)(x) & ~0x1F)

#define HLINK_IS_TERMINATED(x)    ((ptr_to_u32(x) & 0x1) ? 1 : 0)
#define HLINK_IS_SITD(x)          (((ptr_to_u32(x) & 0x6) == 0x4) ? 1 : 0)
