...
/*  Global variables                                                                */
/*----------------------------------------------------------------------------------*/
extern USBH_T      *_ohci0, *_ohci1;
extern HSUSBH_T    *_ehci0, *_ehci1;

extern HC_DRV_T    ohci0_driver, ohci1_driver, ohci2_driver;
extern HC_DRV_T    ehci0_driver, ehci1_driver;
...
int  connect_device(UDEV_T *);
void disconnect_device(UDEV_T *);
...
int usbh_ctrl_xfer(UDEV_T *udev, uint8_t bmRequestType, uint8_t bRequest, uint16_t wValue, uint16_t wIndex, uint16_t wLength, uint8_t *buff, uint32_t *xfer_len, uint32_t timeout);
