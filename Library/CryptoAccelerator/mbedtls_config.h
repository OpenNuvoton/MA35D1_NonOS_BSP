...
//#define MBEDTLS_PLATFORM_STD_PRINTF        sysprintf /**< Default printf to use, can be undefined */
...
//#define MBEDTLS_PLATFORM_PRINTF_MACRO        sysprintf /**< Default printf macro to use, can be undefined */
/* Note: your snprintf must correctly zero-terminate the buffer! */
