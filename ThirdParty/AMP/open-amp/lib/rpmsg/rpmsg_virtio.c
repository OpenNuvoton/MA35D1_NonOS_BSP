...
#ifdef  RTE_Compiler_EventRecorder
  EventRecord2(0xA08, rp_hdr.src, rp_hdr.dst);
  EventRecordData(0xA09, data, size);
#endif
...
#ifdef  RTE_Compiler_EventRecorder
    EventRecord2(0xA06, rp_hdr->src, rp_hdr->dst);
    EventRecordData(0xA07, (void *)RPMSG_LOCATE_DATA(rp_hdr), rp_hdr->len);
#endif
