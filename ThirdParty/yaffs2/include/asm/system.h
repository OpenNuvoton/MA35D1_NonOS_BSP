 ...
 */
void __attribute__((noreturn)) armv8_switch_to_el2(u64 args, u64 mach_nr, u64 fdt_addr,
...
void __attribute__((noreturn)) psci_system_reset2(u32 reset_level, u32 cookie);
