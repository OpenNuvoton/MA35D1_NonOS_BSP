 ...
 * @file     main.c
 *
 * @brief    Use the timer pin PI.1 to demonstrate timer free counting mode
...
void SYS_Init(void)
{
    ...
    SYS->GPI_MFPL |= SYS_GPI_MFPL_PI1MFP_TM0_EXT;
...
int main(void)
{
    ...
    sysprintf("Please connect input source with Timer 0 capture pin PI.1, press any key to continue\n");
    sysgetchar();
