...
int main(void)
{
    ...
    sysprintf("\n\n");
    sysprintf("+--------------------------------------------------------------------+\n");
    sysprintf("|                        SPI Driver Sample Code                      |\n");
    sysprintf("+--------------------------------------------------------------------+\n");
    sysprintf("\n");
    sysprintf("\nThis sample code demonstrates SPI0 self loop back data transfer.\n");
    sysprintf(" SPI0 configuration:\n");
    sysprintf("     Master mode; data width 32 bits.\n");
    sysprintf(" I/O connection:\n");
    sysprintf("     SPI0_MOSI(PL14) <--> SPI0_MISO(PL15) \n");
