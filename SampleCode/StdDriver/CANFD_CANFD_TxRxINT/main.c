...
void CANFD_TestItem(void)
{
    ...
    sysprintf("+-----------------------------------------------------------+\n");
    sysprintf("| [1] Standard ID = 0x111           ( Data lenght  8 bytes )|\n");
    sysprintf("| [2] Standard ID = 0x113           ( Data lenght 12 bytes )|\n");
    sysprintf("| [3] Standard ID = 0x22F           ( Data lenght 16 bytes )|\n");
    sysprintf("| [4] Standard ID = 0x333           ( Data lenght 20 bytes )|\n");
    sysprintf("| [5] Extended ID = 0x221           ( Data lenght 24 bytes )|\n");
    sysprintf("| [6] Extended ID = 0x227           ( Data lenght 32 bytes )|\n");
    sysprintf("| [7] Extended ID = 0x3333          ( Data lenght 48 bytes )|\n");
    sysprintf("| [8] Extended ID = 0x44444         ( Data lenght 64 bytes )|\n");
