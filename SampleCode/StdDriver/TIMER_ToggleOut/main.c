 ...
 * @file     main.c
 *
 * @brief    Demonstrate the timer 0 toggle out function on pin PI.0
 *
...
int main(void)
{
    ...
    sysprintf("\nThis sample code use timer 0 to generate 500Hz toggle output to PI.0\n");
    ...
    u32Clk = TIMER_Open(TIMER0, TIMER_TOGGLE_MODE, 1000);
