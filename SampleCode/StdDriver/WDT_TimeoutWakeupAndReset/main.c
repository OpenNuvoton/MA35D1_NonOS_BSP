...
int main(void)
{
    ...
    sysprintf("| event after 0.512 s, and will be wake up from   |\n");
    ...
    else
    {
    	...
    	WDT_Open(WDT1, WDT_TIMEOUT_2POW14, WDT_RESET_DELAY_18CLK, TRUE, TRUE);
    ...
    while(1)
    {
        ...
        sysprintf("System has been waken up done. WDT interrupt counts: %d.\n\n", g_u32WDTINTCounts);
    }
}
