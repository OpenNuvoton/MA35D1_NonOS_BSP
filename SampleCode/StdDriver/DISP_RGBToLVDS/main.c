 ...
 * @file     main.c
 *
 * @brief    Demonstrate MA35D1 Display Controller RGB interface connect to LVDS
 *           for displaying.
 *
...
void DISP_Open(void)
{
    ...
    /* Configure PK.5 as Output mode */
    GPIO_SetMode(PK, BIT5, GPIO_MODE_OUTPUT);
    /* Set PK.5 output pin value is high */
    PK5 = 1;
}
...
int main(void)
{
    ...
    memcpy((void *)(nc_ptr(DDR_ADR_FRAMEBUFFER)), (void *)(nc_ptr(&ImageDataBase)), file_size);
