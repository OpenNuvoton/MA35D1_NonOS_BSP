 ...
 * @file     main.c
 *
 * @brief    Demonstrate MA35D1 Display Controller RGB interface connect to HDMI
 *           for displaying.
 *
...
int main(void)
{
    ...
    sysprintf("\n+-----------------------------------------------------+\n");
    sysprintf("|      This sample code use an HDMI displays image    |\n");
    sysprintf("+-----------------------------------------------------+\n");
