...
#define     REG_GPIOA_OMD        0x40040000
#define     REG_GPIOA_DOUT       0x40040008
#define     REG_GPIOA_PIN        0x40040010
#define     REG_GPIOA_PUEN       0x40040030
...
typedef enum
{
	...
	eDRVGPIO_GPIOK = 0x280,
	eDRVGPIO_GPIOL = 0x2C0,
	eDRVGPIO_GPIOM = 0x300,
	eDRVGPIO_GPION = 0x340,
} E_DRVGPIO_PORT;
typedef enum
{
    eDRVGPIO_PIN0 = (1),
