...
//const uint32_t nvt_ddr_init_setting_size = sizeof(ddrparam)/sizeof(uint32_t);

#define nvt_ddr_init_setting_size sizeof(custom_ddr)/sizeof(uint32_t)
