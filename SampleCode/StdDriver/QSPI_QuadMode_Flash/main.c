...
{
    SYS->GPD_MFPL =  SYS->GPD_MFPL & ~(SYS_GPD_MFPL_PD4MFP_Msk | SYS_GPD_MFPL_PD5MFP_Msk);
...
{
    SYS->GPD_MFPL =  (SYS->GPD_MFPL & ~(SYS_GPD_MFPL_PD4MFP_Msk | SYS_GPD_MFPL_PD5MFP_Msk)) | SYS_GPD_MFPL_PD4MFP_QSPI0_MOSI1 | SYS_GPD_MFPL_PD5MFP_QSPI0_MISO1;
}
...
int main(void)
{
    ...
    sysprintf("\n+------------------------------------------------------------------------+\n");
    sysprintf("|                    QSPI Quad Mode with Flash Sample Code               |\n");
    sysprintf("+------------------------------------------------------------------------+\n");
    ...
    sysprintf("Start to write data to Flash ...");
    /* Program SPI flash */
    u32FlashAddress = 0;
