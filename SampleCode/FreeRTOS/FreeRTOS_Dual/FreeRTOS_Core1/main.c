 ...
 * @file     main.c
 *
 * @brief    A FreeRTOS project with two demo applications for Core1 Only,
 * 			 with message output to UART16 and execution address
 * 			 set to 0x88000000.
 *
 * @note     TIMER10 has been assigned to FreeRTOS kernel.
 *
